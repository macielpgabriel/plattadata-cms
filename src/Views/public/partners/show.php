...
<nav aria-label="breadcrumb" class="breadcrumb-container">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Socio: <?= e($partnerName) ?></li>
    </ol>
</nav>
...
<div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-3 gap-2 fade-in">
    <div>
        ...
        <div class="text-muted small">
            <?= count($companies) ?> empresa(s) encontrada(s)
        </div>
    </div>
    <?php if ($canSearch): ?>
    ...
    <div class="card-body">
        <?php if (empty($companies)): ?>
            <div class="text-center text-muted py-5">
                ...
                <p class="mb-0">Nenhuma empresa encontrada para este socio.</p>
            </div>
        <?php else: ?>
